/*
 * En esta clase se obtienen los datos del teléfono, asi mismo se genera un json el cual será enviado 
 ...
 * es solicitada a través del servicio, y tendrá el valor de 1 si la prueba es solicitada por el 
 * usuario.
 */
	...
	public void datos_red(){
		...
		if (estado_cel.equals("2")||estado_cel.equals("1")){
			...
			if(estado_cel.equals("3")){
				Toast.makeText(context, "Debes desactivar el modo avión", Toast.LENGTH_SHORT).show();
				mcc=334;
				mnc=0;
				idradiobase = 0;
			}
